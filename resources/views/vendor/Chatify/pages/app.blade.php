...
<div class="whole-page-one-columns">
    ...
    <div class="messenger" style="grid-area: main;">
        ...
        <div class="messenger-listView">
            ...
            <div class="m-header">
                ...
                {{-- Tabs --}}
                <div class="messenger-listView-tabs" hidden>
                    <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users"  hidden>
                        <span class="far fa-user"></span> People</a>
                    <a href="#" @if($route == 'group') class="active-tab" @endif data-view="groups"  hidden>

    ...
    <div class="main-content-column">
        <div class="big-form-container">
            <form style="display: flex; flex-direction: column;" method="post" action="/events"
                ...
                <div class="big-form-group" style="flex-direction: row">
                    <div style="display: flex; flex-direction: column">
                        ...
                        <div class="big-form-column"><label class="big-form-label"
                                ...
                                class="big-form-big-field" type="text" name="description" placeholder="..." required>
                        </div>
                        <div class="big-form-column"><label class="big-form-label"
                                                            for="address">Indirizzo*</label><input
                                class="big-form-big-field" type="text" name="address" required></div>
                        <div class="big-form-row"><label class="big-form-label" for="type">Tipo evento*</label><input
                                class="big-form-compact-field" type="text" name="type" required></div>
                        <div class="big-form-row"><label class="big-form-label" for="max_partecipants">Numero
                                partecipanti</label><input class="big-form-compact-field" type="number" min="0"
                                                           name="max_partecipants" placeholder=""></div>
                        <div class="big-form-row"><label class="big-form-label" for="price">Prezzo</label><input
                                ...
                                placeholder=""></div>
                        <div class="big-form-row"><label class="big-form-label" for="ticket_office">Biglietteria</label><input
                        ...
                        <div class="big-form-row"><label class="big-form-label" for="website">Sito web</label><input
                                class="big-form-compact-field" type="text" id="website" name="website"></div>
                        ...
                        <div class="big-form-row" style="width: auto">
                            ...
                            <div class="radio-selection-item" style="flex-grow: 1">
                                <input
                                    ...
                                    type="radio" class="radio-selection-item-radio" name="registration_link"
                                    value="ticket_office">
                                <label for="registration_link" class="radio-selection-item-label">Dalla
                                    biglietteria</label>
                            </div>
                            <div class="radio-selection-item" style="flex-grow: 1">
                                <input
